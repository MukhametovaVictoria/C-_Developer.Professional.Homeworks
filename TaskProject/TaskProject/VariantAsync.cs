...
{
    /// <summary>
    /// Асинхронное параллельное считывание файлов через Task.WhenAll
    /// </summary>
    public class VariantAsync : IVariant
    {
        public void Start()
        {
            try
        ...
        /// Прочитать 3 файла параллельно и вычислить количество пробелов
        /// </summary>
        public async void ReadThreeFiles()
        {
        ...
        /// Прочитать все файлы в папке и вычислить количество пробелов
        /// </summary>
        public async void ReadFilesInFolder(string folderPath)
        {
            if (String.IsNullOrEmpty(folderPath))
            {
        ...
        public async Task<int[]> GetSpacesInFiles(IEnumerable<string> files)
        {
